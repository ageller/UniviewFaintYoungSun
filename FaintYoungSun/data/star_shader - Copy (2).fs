...
vec4 surface(vec2 starIntersections, vec3 normalizedRay, vec3 compensatedStarColor)
{
...
vec4 corona(float coronaIntersection, vec3 normalizedRay, vec3 compensatedStarColor)
{
...
//previously in a geometry shader
...
//	}
    ...
    {
        color = surface(starIntersections, normalizedRay, compensatedStarColor);
    ...
    else
    {
        ...
        else
        {
            ...
            {
                color = corona(coronaIntersection, normalizedRay, compensatedStarColor);
            }
            else
            {
                //color = vec4(0);
